...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-8 ">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @auth
                        <a type="button" class="btn btn-primary"
                           href="{{route('commentaires.create', ['jeu_id'=> $jeu->id])}}">Ajouter un commentaire</a>
                    @endauth
                    <a href="{{ URL::route('jeu_rules', $jeu->id) }}" class="btn btn-primary">Regarder les régles du
                        jeu</a>
                    <hr>
                    <hr>
                </div>
                ...
                @if ($jeuxInformation->getCommentaires()->count() > 0)
                    ...
                    @else
                        <p>Soyez le premier à donner un commentaire</p>
                    @endif
                </div>
            </div>
        </div>
        <div class="col-4 ">
            <div class="card">
                <img
                    src="https://konnect.serene-risc.ca/wp-content/uploads/2019/02/ascending-graph-1173935_960_720-780x520.png"
